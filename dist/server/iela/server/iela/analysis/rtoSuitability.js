...
exports.calculateDSCR = calculateDSCR;
exports.calculatePTI = calculatePTI;
exports.determineRTOBadge = determineRTOBadge;
exports.analyzeRTOSuitability = analyzeRTOSuitability;
...
function determineRTOBadge(input) {
    ...
    const totalPayment = monthlyMortgage +
        (monthlyTaxes || 0) +
        (monthlyInsurance || 0) +
        (monthlyHOA || 0);
