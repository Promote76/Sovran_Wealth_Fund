...
- **Navigation**: Investor Portal positioned as first item in "Programs" dropdown menu (📊 Investor Portal) for easy access alongside other investor-focused features
