...
async function main() {
  console.log("\n⚡ AXIOM - Deploy CombinedStaking Contracts");
  console.log("============================================\n");
  ...
  const LP_TOKEN = AXM_TOKEN; // Using AXM as LP token for now
  ...
  console.log("💰 Total Gas Spent:", hre.ethers.formatEther(spent), "BNB");
