...
async function main() {
  console.log("\n⚡ AXIOM - Deploy EnhancedNFTMarketplace");
  console.log("=========================================\n");
  ...
  // Estimate gas first
  const Factory = await hre.ethers.getContractFactory("EnhancedNFTMarketplace");
  ...
  console.log("📦 Deploying: EnhancedNFTMarketplace");
  console.log("   NFT marketplace with auctions and royalties");
  console.log("=".repeat(70));
  ...
  console.log("=".repeat(70));
  console.log("");
  console.log("Contract: EnhancedNFTMarketplace");
