...
# Deployment script for Sovran Wealth Fund Staking Contracts using qualified contract names
echo "Starting Polygon Mainnet deployment with qualified contract names..."
...
export MONTHLY_REWARD_RATE="10000000000000000"
...
echo "MONTHLY_REWARD_RATE: $MONTHLY_REWARD_RATE"

# Run the deployment using the qualified script
echo "Running qualified deployment script..."
