          ...
          <div className="bg-blue-50 rounded-xl p-6 mb-6">
            ...
            <div className="space-y-2 text-left">
              <div className="flex items-start">
                ...
                <span className="text-gray-700"><strong>1% platform fee</strong> (50% off lifetime)</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-700"><strong>Early access</strong> to tokenized properties</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-700"><strong>Priority support</strong> & exclusive updates</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <div className="inline-block bg-yellow-400 text-gray-900 px-4 py-2 rounded-full text-sm font-semibold mb-6">
            🚀 LAUNCHING SOON - Founding Member Spots Available
          </div>
          
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Invest in U.S. Real Estate<br />
            <span className="text-blue-300">with Crypto</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-blue-100 mb-8">
            First platform to capitalize on the <strong>GENIUS Act</strong><br />
            Unlocking the <strong>$52 Billion</strong> crypto real estate market
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-12">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-white">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <div className="text-sm text-blue-100">Fee Discount</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-gray-600 text-center mb-6">
            First 100 investors get <span className="text-blue-600 font-bold">50% off</span> platform fees
          </p>
        ...
        <div className="max-w-6xl mx-auto mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
            ...
            <p className="text-blue-100">
              Invest in U.S. real estate starting at just $500 with blockchain-verified ownership
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
            ...
            <p className="text-blue-100">
              Earn monthly rental distributions directly to your wallet in stablecoins
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
            ...
            <p className="text-blue-100">
              KYC/AML compliant, wallet screening, and SEC-registered securities
            </p>
          </div>
        </div>
      </div>
